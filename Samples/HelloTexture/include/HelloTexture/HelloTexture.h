...
class HelloTexture : public SampleBase
{
public:
    HelloTexture(PlatformBase& _platform);
    virtual ~HelloTexture();

    static HelloTexture* Create(PlatformBase& _platform);
    static void Destroy(HelloTexture* _app);
...
public:
    ...
    const char* GetName() const override { return "HelloTexture"; }
